<%@ Page Title="" Language="C#" MasterPageFile="~/ShortForm.Master" AutoEventWireup="true" CodeBehind="ManageCars.aspx.cs" Inherits="FYP_CarRentalSystem.Admin.ChooseCar" %>
            ...
            <AlternatingItemTemplate>
                <td runat="server" style="background-color:#FFF8DC; color:black">
                   ...
                   <%-- <asp:Button ID="Button2" runat="server" Text="Check Details" Width="250"/>
                    <br />--%>
                    <a class="linkclass" href='/Admin/Detail.aspx?CarId=<%# Eval("CarId") %>'>Check Details</a>
                    <br /><hr />
                    <a class="linkclass" href='/Admin/Edit.aspx?CarId=<%# Eval("CarId") %>'>Edit</a>
