...
{
    private const string s_connPrefix = "Server=.\\SQLExpress; Database=UsersDb;Trusted_Connection=Yes;AttachDbFilename=|Datadirectory|";
    ...
    private static void BuildConnectionForFileName(string dbFileName)
    {
        ...
        ////////////////////////////////////////////////////////////////////
        // Step 2: Check it's a full path: use as-is, if it is a full path
        ...
        ////////////////////////////////////////////////////////////
        // Step 3: Ensure that it doesn't try to pick a directory
    ...
    {
        if (applicationID == 0 || userName == null || userName.Length < 1) // User doesn't exist
            return 0;
